...
export default function PaymentAndPrice() {
  ...
  const amountToCollect = useOrderStore(
    (state) => state.orderData.amountToCollect
  );
  ...
  const labelStyle =
    'text-sm font-bold text-gray-700 mb-1.5 flex items-center gap-2';
        ...
        <div className="flex flex-col">
          ...
          <div className="relative">
            <input
              ...
              onChange={(e) =>
                updateOrderData('deliveryPrice.discount', e.target.value)
              }
              placeholder="0.00"
            />
            <span className="absolute right-4 top-1/2 -translate-y-1/2 text-[10px] text-gray-400 font-black">
          ...
          {discountError && (
            <span className="text-red-500 text-sm">Ilegal discount!</span>
          )}
        </div>
        ...
        <div className="flex flex-col">
          ...
          <div className="relative">
            <input
              ...
              onChange={(e) =>
                updateOrderData('amountToCollect', e.target.value)
              }
              placeholder="0.00"
            />
            <span className="absolute right-4 top-1/2 -translate-y-1/2 text-[10px] text-gray-400 font-black">
      ...
      <div className="pt-8 border-t border-gray-100">
        <div className="max-w-md">
          ...
          <div className="max-w-xs">
            ...
            />
            {paymentTypeError && (
              <span className="text-red-500 text-sm">Select payment type</span>
            )}
          </div>
        </div>
      </div>
